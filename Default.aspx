<%@ Page Title="Careers" Language="C#" MasterPageFile="~/templates/siteTemplateResponsive2017nocont.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="careers_Default" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="mainBody" Runat="Server">
               ...
               <div id="home" class="full-width-hero  visible-xl" style="background-image: url('https://assets.syngentaebiz.com/images/media/background-blue-swish (2).svg');">
            <img src="https://assets.syngentaebiz.com/images/media/headerimage_1@2x.png" class="img-responsive abso1" alt="Professionals working together">
            <img src="https://assets.syngentaebiz.com/images/media/headerimage_2@2x.png" class="img-responsive abso2" alt="Delivery man with seeds">

            <img src="https://assets.syngentaebiz.com/images/media/headerimage_3@2x.png" class="img-responsive abso3" alt="Students working together">
            <img src="https://assets.syngentaebiz.com/images/media/headerimage_4@2x.png" class="img-responsive abso4" alt="Farmer planting crops">
            <div class="container">
              <div class="row">

                <div class="mktbs-call-out">
                  <h1>Syngenta US Careers</h1>
                  <span class="mktbs-title">Your Work Matters</span>
                  <p>Join Syngenta and help build the most collaborative and trusted team in agriculture. No matter what your position, you will have a vital role to play in safely feeding the world and taking care of our planet.</p>
            ...
            <div class="container">
              <div class="row">
                <div class="nav-col">
                   ...
                   <a href='<%=ResolveUrl("Default.aspx")%>'  class="current">Home</a>
                  ...
                  <a href='<%=ResolveUrl("professionals/Default.aspx")%>' class="">Professionals</a>
                    ...
                    <div class="container content-box ipn-ele" id="whyWork">
            <div class="row">

            <div class="col-sm-10 col-sm-push-1">
              <h2 class="text-center black">Your Life at Syngenta</h2>
              <p class="text-center">We want to help tomorrow’s leaders thrive. At Syngenta you will be part of a global company that is rooted in science and is working to accelerate our innovation to address grower’s challenges.</p>
              <p class="text-center">As we invest in technologies that matter, we strive to bring a positive, lasting change for more sustainable agriculture. With us you will have the opportunity to address these challenges in ways that everyone wins- from growers, to consumers, to the environment.</p>
              <div class="d-flex justify-content-center mt-4 mb-3">
                <a href='<%=ResolveUrl("students/Default.aspx")%>' class="shadow-link mr-1">Students</>
                <a href='<%=ResolveUrl("professionals/Default.aspx")%>' class="shadow-link ml-1">Professionals</a>
              </div>

              <div class="d-flex justify-content-center mt-4 mb-3 flex-column">
                <h3 class="text-center black">Video headline goes here</h3>

                <img src="https://assets.syngentaebiz.com/images/media/placehold.svg" class="img-responsive video">
...
<div class="container content-box ipn-ele" id="ourCulture">
  <div class="row">
    <div class="col-sm-10 col-sm-push-1">

      <h2 class="text-center black">Our Culture</h2>
      <p class="text-center">We believe in the need to have passion for customers, take a long-term view, seek growth for all, be determined in our execution, and that how we do things matters.</p>
      <p class="text-center"> We are inspired by our purpose – bringing plant potential to life – as it guides our work. Working at Syngenta will allow you to embrace unique perspectives, capabilities and <a href="https://www.syngenta.com/en/careers/working-syngenta/diversity-and-inclusion" target="_blank">diversity of employees</a>, to help catalyze innovation, maximize performance and create business value.</p>

      <h2 class="text-center black mt-5 mb-0">Benefits</h2>

      <div class="d-flex flex-column align-items-center icons">


        <img src="https://assets.syngentaebiz.com/images/media/icon_comprehensive_benefits.svg" class="img-responsive" alt="">


        <p>Comprehensive benefits package for eligible employees that starts your first day (including medical, dental and vision insurance)</p>


        <img src="https://assets.syngentaebiz.com/images/media/icon_401k.svg" class="img-responsive" alt="">

        <p>401K savings plan with a company match, profit sharing and retirement savings contribution</p>

        <img src="https://assets.syngentaebiz.com/images/media/icon_flexible_hours.svg" class="img-responsive" alt="">

        <p>Flexible working arrangements, summer work hours, PTO, paid holidays and parental leave</p>


        <img src="https://assets.syngentaebiz.com/images/media/icon_wellness_programs.svg" class="img-responsive" alt="">



        <p>Wellness programs and corporate discounts</p>

        <img src="https://assets.syngentaebiz.com/images/media/icon_work_life_balance.svg" class="img-responsive" alt="">


        <p>Work/life balance, employee well-being support and employee family resources</p>
...
<div class="container ipn-ele" id="careersFAQ">
  <h2 class="text-center black mb-0">FAQs</h2>
  <div class="col-sm-10">
    <div class="accordion-group accordion-group">
      <button class="accordion" onclick="event.preventDefault()">
        <strong>What can I expect from the application process?</strong></button>
      <div class="panel">
        <div class="row">
          <p>If your experience aligns with our requirements, you may be contacted by a member of our team to discuss next steps in the recruitment process.</p>
        </div>
      </div>
    </div>
    <div class="accordion-group">
      <button class="accordion" onclick="event.preventDefault()"><strong>Is education assistance available?</strong></button>
      <div class="panel">
        <div class="row">
          <p>Educational assistance is available for job-related or degree program college coursework with HR and management approval.</p>
        </div>
      </div>
    </div>
