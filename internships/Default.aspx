<%@ Page Title="Careers" Language="C#" MasterPageFile="~/templates/siteTemplateResponsive2017nocont.master"  AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Careers_internships_Default" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="mainBody" Runat="Server">
           ...
           <div id="home" class="full-width-hero internships">
          ...
          <div class="container ipn-ele" id="students">
            <div class="row">
              ...
              <div class="col-md-10 col-md-push-1 col-sm-12">
                <h2 class="text-center black">Internships</h2>
                <p class="text-left">Syngenta internships are designed to provide you a window into the day-to-day operations in your chosen field of study and an opportunity to develop a relationship with Syngenta while still in school. A great opportunity for college students, Syngenta internships allow you to observe, engage and apply classroom principles at a leading business in the agricultural industry. As an intern you are paired with a mentor to maximize your engagement opportunities and expand your contacts within Syngenta. You will be exposed to independent project work as well as job shadowing and cross-functional job opportunities. We firmly believe in growing talent within our organization. This is an excellent opportunity for you to introduce yourself to Syngenta and position yourself for a potential position after graduation.</p>

                <p class="text-left strong mb-0 mt-3">About the program</p>
                <p class="text-left mt-0">Syngenta offers a variety of internship options depending on the location and responsibility including short-term, seasonal co-op opportunities and multi-year positions. The internship program is a great fit for you if you are a bright, ambitious student who is motivated to help large and small-scale farmers meet the challenge of global food security.</p>
                  ...
                  <div class="row">
                    ...
                    <div class="accordion-group accordion-group">
                      <button class="accordion" onclick="event.preventDefault()">
                        <strong>Seed Sales Internship</strong></button>
                      <div class="panel">
                        <div class="row">
                          <p>The Syngenta Seeds Sales Intern program is a curriculum-based, integrated learning opportunity that prepares you to be a leader in territory sales in the agriculture industry. This is a 10-week summer program designed to help you gain customer experience. As an intern you will develop an understanding of customer needs by engaging growers and resellers in solution-based consultative selling; developing product and technical expertise; refining communication, presentation and leadership skills; and building a thorough understanding of company structure, roles, functions and core values. District managers will coach and mentor to help you achieve development goals for independent account experience.</p>
                          <p class="strong mb-0">About the program</p>
                          <p>Seeds Sales Intern geographical assignments are based on a variety of factors, and while we can’t guarantee a specific location, every effort will be made to place you close to your desired geography (some travel requirements). Placements may be in the field or in an office assignment.</p>
                          <p class="strong mb-0">Growth Opportunities</p>
                          <p>
                            <ul>
                              <li>Participate in intern team activities including orientation, poster presentation and conference calls</li>label
                              <li>Develop sales, communication, presentation and leadership skills under a local mentor</li>
                              <li>Understand grower and reseller needs to position and manage products</li>
                              ...
                              <li>Learn how to manage competitive allowance budget and other company resources (travel expenses, use of fleet vehicle and company cell phone)</li>
                    ...
                    <div class="accordion-group">
                      <button class="accordion" onclick="event.preventDefault()"><strong>Crop Protection Sales Internship</strong></button>
                      <div class="panel">
                        <div class="row">
                          ...
                          <p>
                            <ul>
                              <li>Participate in intern team activities including orientation, presentations and conference calls</li>label
                              <li>Develop sales, communication, presentation and leadership skills under a local mentor</li>
          ...
          <div class="container-fluid pl-0 pr-0 d-flex justify-content-center mt-3 mb-4 flex-column align-items-center content-box" id="job">
            <div class="row page-break">
              ...
              <h2 class="text-center black">Find Internships</h2>
